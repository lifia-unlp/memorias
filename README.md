...
| ✉️ **Configure Notifications** | **[notifications.md](file:///Volumes/X-Wing/casco/Development/memorias-migration-antigrativy/memorias-web/docs/notifications.md)** | Comprehensive guide to immediate alerts, scheduled digests, and SMTP setup. |
